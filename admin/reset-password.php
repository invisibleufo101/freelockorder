        ...
        if(!password_verify($password, $result['password'])){
            ...
            if ($new_password !== $confirm_password){
                ...
                if ($new_password === $password){
                    $change_err = "* No change from previous password";
                }
                else{   
                    ...
                    <script>
                        ...
                        // catalogue.php refers to the admin catalogue since both files are in the same lvl dir
...
<div class="container">
    ...
    <div class="col-md-offset-3">
        <form class="form-horizontal" action="" method="post" style="padding-top: 50px;">
            ...
            <div class="col-md-4" style="left: 30%;">
                <input type="submit" class="btn btn-primary" name="password_submit" value="Reset Password">
            </div>
        </form>
    </div>
</div>
