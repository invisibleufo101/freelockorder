                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="Product Name" value="<?php echo $row['productname']; ?>" name="pname">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="Price ($)" value="<?php echo $row['price']; ?>" name="price">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
